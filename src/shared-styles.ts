...
export const SHARED_CSS = `
  ...
  *, *::before, *::after { box-sizing: inherit; }
  ...
  /* ===== Venue Chat (modal + FAB) ===== */
  .avq-chat-root { position: fixed; bottom: 24px; right: 24px; z-index: 2147483646; font-family: inherit; }
  .avq-chat-fab {
  ...
  .avq-chat-fab:hover { box-shadow: 0 10px 28px rgba(15, 15, 16, 0.18); transform: translateY(-1px); }
  .avq-chat-fab-icon { display: inline-flex; align-items: center; justify-content: center; line-height: 1; flex-shrink: 0; }
  .avq-chat-fab-icon svg { width: 18px; height: 18px; }
  ...
  @media (max-width: 480px) {
    .avq-chat-overlay { padding: 0; align-items: stretch; justify-content: stretch; }
    .avq-chat-modal { max-width: 100%; height: 100vh; border-radius: 0; }
  }
  .avq-chat-modal-head {
  ...
  .avq-chat-modal-head strong { font-size: 15px; font-weight: 600; color: #111; }
  .avq-chat-close {
  ...
  .avq-chat-form { display: flex; flex-direction: column; gap: 12px; padding: 16px; overflow-y: auto; }
  .avq-chat-form label { display: flex; flex-direction: column; gap: 4px; font-size: 13px; color: #444; font-family: inherit; }
  .avq-chat-form input,
  .avq-chat-form textarea {
    font: inherit; font-size: 14px;
    padding: 10px;
    border: 1px solid #ddd; border-radius: 8px;
    width: 100%; box-sizing: border-box;
    resize: vertical; color: #111; background: #fff;
  }
  .avq-chat-form input:focus,
  .avq-chat-form textarea:focus { outline: none; border-color: #111; box-shadow: 0 0 0 3px rgba(15,15,16,0.08); }

  .avq-chat-error { color: #c0392b; font-size: 13px; margin: 0; }
  .avq-chat-info { color: #555; font-size: 13px; padding: 16px; margin: 0; text-align: center; }
  ...
  .avq-chat-submit, .avq-chat-send { background: var(--avq-accent, #111); color: #fff; }
  .avq-chat-submit:disabled, .avq-chat-send:disabled { opacity: 0.55; cursor: not-allowed; }
  .avq-chat-cancel { background: #f1f1f1; color: #333; }

  .avq-chat-view { flex: 1; display: flex; flex-direction: column; min-height: 0; }
  .avq-chat-messages { flex: 1; overflow-y: auto; padding: 12px; display: flex; flex-direction: column; gap: 8px; }
  .avq-chat-bubble { max-width: 78%; padding: 8px 12px; border-radius: 14px; font-size: 14px; line-height: 1.4; word-wrap: break-word; }
  .avq-chat-bubble-customer { align-self: flex-end; background: var(--avq-accent, #111); color: #fff; border-bottom-right-radius: 4px; }
  .avq-chat-bubble-venue { align-self: flex-start; background: #f1f1f1; color: #111; border-bottom-left-radius: 4px; }
  .avq-chat-bubble-body { white-space: pre-wrap; }
  .avq-chat-bubble-time { font-size: 11px; opacity: 0.6; margin-top: 2px; }

  .avq-chat-composer { display: flex; gap: 8px; padding: 10px 12px; border-top: 1px solid #eee; background: #fff; flex-shrink: 0; }
  .avq-chat-composer textarea {
    flex: 1; font: inherit; font-size: 14px;
    padding: 8px;
    border: 1px solid #ddd; border-radius: 8px;
    resize: none; color: #111; background: #fff;
  }
  .avq-chat-composer textarea:focus { outline: none; border-color: #111; }
`
